...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	ON_WM_CREATE()
	ON_COMMAND(go_btn, OnBnClickedbtn)
END_MESSAGE_MAP()
...
// CMainFrame 消息处理程序
void CMainFrame::OnBnClickedbtn()
{
	// TODO: 在此添加控件通知处理程序代码
	CString url;
	m_wndDlgBar.GetDlgItem(url_input)->GetWindowText(url);
	//AfxMessageBox(url);
	((CMFCBrowserView*)GetActiveView())->Navigate(url);
}

void CMainFrame::SetPage(LPCTSTR lpszURL)
{
	m_wndDlgBar.GetDlgItem(url_input)->SetWindowText(lpszURL);
}